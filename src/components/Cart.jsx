...
import qr from "../assets/images/qrcode.jpg"; // Import the logo image
...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    cart.forEach((ele) => {
      ...
      calculatedTotal += parseFloat(ele.price); // or Number(ele.price)
    });
  ...
  return (
    <div className="ShoppingCart">
      ...
      <div className="card">
        ...
        <h4 className="Total">Total: {total} Rs</h4>
      </div>
      <button
        className="checkout"
      ...
      <Modal show={showModal} onHide={closeModal} centered>
      <Modal.Header closeButton>
        <Modal.Title>Scan the below QR to pay</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {/* Add the QR code image here */}
        <img
          src={qr} // Path to your QR code image
        ...
        <p style={{ textAlign: "center", marginTop: "10px" }}>
          ...
          You will get an email regarding your purchase.
        </p>
      </Modal.Body>
      <Modal.Footer>
        <button
